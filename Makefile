...
rpkg:
	...
	cp src/io/image_seg_recordio.h R-package/src
	...
	rm -rf R-package/src/image_seg_recordio.h
...
clean: cyclean testclean $(EXTRA_PACKAGES_CLEAN)
	$(RM) -r build lib bin *~ */*~ */*/*~ */*/*/*~ R-package/NAMESPACE R-package/man R-package/R/mxnet_generated.R \
		R-package/inst R-package/src/image_recordio.h R-package/src/image_seg_recordio.h R-package/src/*.o R-package/src/*.so mxnet_*.tar.gz \
